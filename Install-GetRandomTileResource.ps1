...
Set-Content -Path (Join-Path -Path $WindowsPowerShellPath -ChildPath "Import-GetRandomTileResource.ps1") -Value ((New-Object System.Net.WebClient).DownloadString("https://gist.github.com/vercellone/bdf13d74caded715afaa/raw/")) -Force
...
if (Test-Path -Path $profilepath) {
    ...
    Set-Content -Path $profilepath -Value '. (Join-Path -Path $home -ChildPath "documents\windowsPowerShell\Import-GetRandomTileResource.ps1")' -Force
